...
public class main_bat {
	...
	public static void main(String args[]) {
		...
		for (int i = 0; i < 10; i++) {
			...
			//basketball
			//main_bat b = new main_bat(96,40, 5, 0.01, 0.7, 10000, 20,5);
			//BF
			//main_bat b = new main_bat(252,40, 15, 0.3, 0.01, 1000, 10,5);
			//Quak Qk.txt
			main_bat b = new main_bat(2178,40, 4, 0.01, 0.7, 1000, 10,5);
			//ibm-standard.txt
			//main_bat b = new main_bat(1000,40, 20, 0.1, 0.5, 200, 10,5);
			//chess
			//main_bat b = new main_bat(3196,75, 37, 0.0, 0.1, 200, 10,5);
			//mashroom
			//main_bat b = new main_bat(8124,119, 23, 0.2, 0.5, 200, 10,5);
			//pumsb
			//main_bat b = new main_bat(40385,7116, 50, 0.0, 0.0, 10, 10,5);
			//BMS1.txt
