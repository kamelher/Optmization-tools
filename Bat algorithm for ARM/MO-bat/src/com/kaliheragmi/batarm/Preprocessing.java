...
public class Preprocessing {
	...
	public void printMap() {
		change();
		try {
			BufferedWriter write = new BufferedWriter(new FileWriter(new File("/home/kamel/Mycloud/WorkSpace/MO-bat/src/com/kaliheragmi/batarm/tr.txt")));
			for (Integer in : vertical_rep.keySet()) {
				if ( vertical_rep.get(in).size()==0) {
					write.write(-1+" ");
				}
	...
	public static void main(String[] args) {
		...
		File f = new File("/home/kamel/Mycloud/WorkSpace/MO-bat/src/com/kaliheragmi/batarm/DATA/Qk.txt");
		Preprocessing p =new Preprocessing(f,40);
		p.load();		
		p.printMap();
